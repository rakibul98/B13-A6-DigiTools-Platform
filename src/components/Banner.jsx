      ...
      <div className="max-w-7xl flex-col md:flex-row mx-auto flex gap-14 items-center mt-20  ">
        <div className="flex-1 space-y-5 text-center md:text-left flex flex-col">
          <div className="flex gap-1 items-center justify-center mx-auto md:mx-0 rounded-full bg-indigo-100 py-3 w-[294px] hover:cursor-pointer hover:shadow-lg shadow-indigo-300 transition duration-300">
            ...
            <span className="font-medium bg-linear-to-r from-[#4F39F6] to-[#9514FA] bg-clip-text text-transparent">New: AI-Powered Tools Available</span>
          </div>
          ...
          <div className="flex gap-4 pt-4 justify-center md:justify-start">
            ...
            <button className="btn border border-purple-500 rounded-full flex items-center gap-2 px-6 py-2
                                transition-all duration-300 ease-in-out
                                hover:bg-purple-50 hover:scale-105 hover:shadow-md">

              <img src={Play} alt="" className="transition-transform duration-300 group-hover:translate-x-1" />
